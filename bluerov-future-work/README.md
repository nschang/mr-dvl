...
- ADD Nvidia Jetson Nano to replace RPi as onboard companion SBC. (for vastly greater computing performance and, running as low as 5 watts, equip the ROV with the power of modern AI, including accelerated libraries for deep learning, computer vision, graphics, multimedia, and more. This enables quite a number of interesting applications, such as automatic object identification / obstacle avoidance / real-time 3D mapping / potential for autonomous operations, and more.) See  discussion [here on BlueROV Forum](https://discuss.bluerobotics.com/t/proposed-advanced-sub-surface-rov-control-platform/4747) and some interesting projects [here at /jetson-projects](/bluerov-future-work/jetson-projects).
